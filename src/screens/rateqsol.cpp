...
menu::menu_item eq_menuitems[] = {{"R = U/I", false, solvinator, 0}, {"F = k * Q1*Q2 / r^2", false, solvinator, 1}};

zcas::ratio_eq equations[] = {{1, {{cln::cl_symbol{"U"}, 1}, {cln::cl_symbol{"I"}, -1}, {cln::cl_symbol{"R"}, -1}}},
